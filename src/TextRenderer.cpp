...
// font8x8_basic — public domain 8x8 bitmap font (ASCII 0x20..0x7E).
// One byte per row; bit 0 (LSB) is the leftmost column.
namespace {
...
int draw(SDL_Renderer* r, int x, int y, const std::string& text,
    ...
    for (unsigned char ch : text) {
        ...
        // Non-printable / non-ASCII (e.g. UTF-8 continuation bytes): skip, no advance.
        if (ch >= 0x20) penX += ADVANCE * scale;
    }
    return penX;
}
